...
plt.plot(epochs, loss_train_his, 'g', label='Training loss')
plt.plot(epochs, loss_test_his, 'b', label='Test loss')
plt.title('Training and Test loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()

plt.savefig("loss_output.jpg")


acc_plot = plt.figure(2)

plt.plot(epochs, acc_train_his, 'g', label='Training Accuracy')
plt.plot(epochs, acc_test_his, 'b', label='Test Accuracy')
plt.title('Training and Test Accuracy')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()

plt.savefig("acc_output.jpg")
