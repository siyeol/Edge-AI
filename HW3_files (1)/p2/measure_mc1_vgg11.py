...
out_fname = 'log_mc1_vgg11.csv'
header = "time_stamp, total_power, temps_avg,"
...
while True:
    ...
    print('Temperature of core average:', temps_avg)
    ...
    # Data write out:
    fmt_str = "{}," * 3
    out_ln = fmt_str.format(time_stamp, total_power, temps_avg)
