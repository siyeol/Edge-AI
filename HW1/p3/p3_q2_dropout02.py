...
parser.add_argument('--conv1_ch_size', type=int, default=8, help='Conv1 channel size')
# Define the conv2 channel size of your optimizer
parser.add_argument('--conv2_ch_size', type=int, default=16, help='Conv2 channel size')
...
plt.savefig("p3_q2_loss_output_dropout" + "_epochs_" + str(num_epochs) + "_conv1_ch_" + str(conv1_ch_size) + "_conv2_ch_" + str(conv2_ch_size) + ".jpg")
...
plt.savefig("p3_q2_acc_output_dropout" + "_epochs_" + str(num_epochs) + "_conv1_ch_" + str(conv1_ch_size) + "_conv2_ch_" + str(conv2_ch_size) + ".jpg")