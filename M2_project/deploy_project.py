...
parser.add_argument('--model', type=str, default="5percent_pruned_zeroelim", help='Model to train')
args = parser.parse_args()

# TODO: Modify the rest of the code to use those arguments correspondingly

onnx_model_name = args.model+".onnx" # TODO: insert ONNX model name, essentially the path to the onnx model
